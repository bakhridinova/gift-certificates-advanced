...
public class CertificateRepositoryTest extends RepositoryTest {
    ...
    public void findAllByPageShouldReturnInitialList() {
        ...
        certificateRepository.findAllByPage(pagination)
                .forEach((certificate) -> {
    ...
    public void findByFilterShouldReturnInitialListInAscendingIdOrder() {
        ...
        List<Certificate> certificates =
                certificateRepository.findByFilterAndPage(searchFilter, pagination);
    ...
    public void findByFilterShouldReturnEmptyListIfNamesDoNotMatch() {
        ...
        assertTrue(certificateRepository
                .findByFilterAndPage(searchFilter, pagination).isEmpty());
    }
    ...
    public void deleteShouldRemoveRecordFromDatabase() {
        ...
        certificateRepository.save(certificate);
        assertEquals(1,
                certificateRepository.findAllByPage(pagination.next()).size());
