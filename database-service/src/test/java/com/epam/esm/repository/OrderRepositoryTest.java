...
public class OrderRepositoryTest extends RepositoryTest {
    ...
    public void findAllByPageShouldReturnInitialList() {
        ...
        orderRepository.findAllByPage(pagination)
                .forEach((order) -> {
    ...
    @Test
    @Order(7)
    public void findByUserIdShouldReturnCorrectListIfUserExists() {
        List<com.epam.esm.entity.Order> orders =
                orderRepository.findByUserId(1L, pagination);
    ...
    @Test
    @Order(8)
    public void findByUserIdShouldThrowDataAccessExceptionIfUserIdIsNull() {
        assertThrows(DataAccessException.class,
                () -> orderRepository.findByUserId(null, pagination));
    }

    @Test
    @Order(9)
    public void findByCertificateIdShouldReturnCorrectCertificateIfCertificateExists() {
        List<com.epam.esm.entity.Order> orders =
                orderRepository.findByCertificateId(1L, pagination);
        assertEquals(1, orders.size());
        com.epam.esm.entity.Order order = orders.get(0);
        assertEquals(1,
                order.getId());
    ...
    @Test
    @Order(12)
    public void findByCertificateIdShouldThrowDataAccessExceptionIfCertificateIdIsNull() {
        assertThrows(DataAccessException.class,
                () -> orderRepository.findByCertificateId(null, pagination));
    }
